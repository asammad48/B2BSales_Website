        ...
        <div className="flex-grow flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 flex-shrink-0">
            ...
            <div className="flex items-center gap-2">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    product?.canOrder
                      ...
                      : 'bg-surface border border-border text-text-muted pointer-events-none opacity-50',
                  )}
                  aria-disabled={!product?.canOrder}
                  title={product?.canOrder ? 'Order now' : 'Ordering unavailable'}
                >
              ...
              <Link to={detailPath} className="w-10 h-10 rounded-xl bg-surface border border-border text-text-muted flex items-center justify-center transition-all hover:bg-primary hover:text-white hover:border-primary">
