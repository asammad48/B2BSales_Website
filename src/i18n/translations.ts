...
export const translations: Record<SupportedLanguage, TranslationTree> = {
  en: {
    ...
    productDetail: {
      ...
      reviews: '4.9 (128 reviews)', priceLocked: 'Price locked', signInForRates: 'Please sign in as a partner to view wholesale rates.', loginToOrder: 'Sign in to order',
      freeShipping: 'Free express shipping from {{currency}}500', nextDay: 'Next day', deliveryAvailable: 'Delivery available', warrantyDays: '30 days', warrantyIncluded: 'Warranty included',
      tabs: { description: 'Description', specs: 'Specifications', shipping: 'Shipping & returns' },
      noDescription: 'No detailed description is available for this part.',
      bullets: { '1': 'A+ premium quality', '2': 'Fully tested before shipping', '3': 'Compatible with original chassis', '4': 'Professional installation recommended' },
      specs: {
        partType: 'Part type', component: 'Component', sku: 'SKU', compatibility: 'Compatibility', weight: 'Weight', material: 'Material', materialValue: 'OEM standard', condition: 'Condition', conditionValue: 'New',
      },
      shippingText: 'We ship worldwide with DHL, FedEx, and UPS. Orders placed before 2:00 PM EST are shipped the same day.',
      returnPolicyTitle: 'Return policy',
      returnPolicyText: 'Returns for defective parts are accepted within 30 days. Parts must be in original condition with all protective films.',
    ...
    common: { na: 'N/A', itemCount: '{{count}} item', itemCountPlural: '{{count}} items', beforeTax: 'Before tax', unknownShop: 'Unknown shop', unknownDate: 'Unknown date', unknownStatus: 'Pending' },
    notFound: {
